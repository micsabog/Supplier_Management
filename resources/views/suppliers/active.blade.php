...
@section('breadcrumb', 'Active Suppliers')

@section('content')
    <h1 class="text-2xl font-bold flex items-center gap-2 mb-1">✅ Active Suppliers</h1>
    <p class="text-gray-500 mb-6">List of suppliers that are currently active and approved for operations</p>
